...
- `global-codex-wrapper.sh` — installs to `~/.local/bin/codex` and launches Codex with hook-trust checks bypassed; this machine is fully owned and all enabled hooks are trusted.
