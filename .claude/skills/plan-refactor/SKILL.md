...
1. Read the bundled [coding-guide.md](coding-guide.md) in this skill's directory. Also check CLAUDE.md for any additional project-level coding guide and read that too if found. All coding guides drive the scan.
...
3. Scan codebase via parallel `Task` subagents. Derive categories from coding guide principles (file size, error handling, duplication, large types, test coverage, dead code, etc.).
