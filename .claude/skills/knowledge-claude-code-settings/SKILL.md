...
description: >
  Claude Code settings gotchas: auto-compact is a token window not a %; hooks+env
  load once at session start; verify a setting by grepping the binary. Load for global-settings.json edits.
...
<!-- Last verified: 2026-07-01, commit: 608aef8 -->
