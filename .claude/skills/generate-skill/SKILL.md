...
Create or edit a skill in `.claude/skills/`.
...
2. Derive a short kebab-case name from the description. Check if `.claude/skills/<name>/SKILL.md` exists. If editing, read it.
3. Create `.claude/skills/<name>/` directory if needed. Write the SKILL.md file following these rules:
